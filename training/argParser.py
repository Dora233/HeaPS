...
parser.add_argument('--task', type=str, default='speech')
...
parser.add_argument('--numofclients', type=int, default=3001)
...
parser.add_argument('--leaderFactor', type=float, default=0.5)
